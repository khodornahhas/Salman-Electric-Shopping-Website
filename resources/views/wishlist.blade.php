...
@section('head')
    <title>Salman Electric - Wishlist</title>
    ...
    <div class="w-full max-w-7xl p-4 sm:p-6"> 
        ...
        <div class="grid gap-6 justify-center mx-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-7xl px-4 sm:px-6">
            @foreach($wishlists as $wishlist)
                ...
                @endphp
                <div class="relative bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col group mx-auto w-full h-[370px]"> 
